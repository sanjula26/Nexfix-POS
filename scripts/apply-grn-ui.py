...
rep('src/App.tsx',"const SupplierPayments = lazy(() => import('./pages/SupplierPayments'));\nconst Purchases", "const SupplierPayments = lazy(() => import('./pages/SupplierPayments'));\nconst GRN = lazy(() => import('./pages/GRN'));\nconst Purchases")
...
rep('src/components/AppLayout.tsx',"  [/^\\/customers/, 'Customers'], [/^\\/suppliers/, 'Suppliers'], [/^\\/supplier-payments/, 'Supplier Payments'], [/^\\/purchases/, 'Purchases'],", "  [/^\\/customers/, 'Customers'], [/^\\/suppliers/, 'Suppliers'], [/^\\/supplier-payments/, 'Supplier Payments'], [/^\\/grn/, 'Goods Received Notes'], [/^\\/purchases/, 'Purchases'],")
