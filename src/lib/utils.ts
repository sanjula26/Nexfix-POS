...
const SHA256_K=[0x428a2f98,0x71374491,0xb5c0fbcf,0xe9b5dba5,0x3956c25b,0x59f111f1,0x923f82a4,0xab1c6c7c,0xd807aa98,0x12835b01,0x243185be,0x550c7dc3,0x72be5d74,0x80deb1fe,0x9bdc06a7,0xc19bf174,0xe49b69c1,0xefbe4786,0x0fc19dc6,0x240ca1cc,0x4a748aa0,0x5cb0a9dc,0x76f988da,0x983e5152,0xa831c66d,0xb00327c8,0xc6e00bf3,0xd192e819,0x106aa070,0x19e376c08,0x2748774c,0x34b0bcb5,0x4ed8aa4a,0x5b9cca4f,0x6826ff3,0x748f82ee,0x78a5636f,0x84c87814,0x8cc70208,0x90befffa,0xa4506ceb,0xc67178f2];
...
export const hashPin=(plain:string):string=>hashPassword(plain);
export const verifyPin=(plain:string,storedHash:string):boolean=>verifyPassword(plain,storedHash);
