    ...
    <div className="min-h-screen flex bg-[#f5f6fb]">
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative">
        ...
        <div className="w-full max-w-md">
          <Link to="/signup" className="inline-flex items-center gap-2 text-xs font-semibold text-violet-600 bg-violet-500/10 border border-violet-500/20 rounded-full px-4 py-2 mb-5"><ArrowLeft size={13} /> New customer? Register here</Link>
