-- Fix the atomic return RPC's additional-payment variable reference.
-- This migration is intentionally idempotent and preserves the secured RPC shape.
...
declare
  ...
  v_refund numeric := 0; v_additional numeric := 0; v_sale_subtotal numeric := 0; v_sale_discount numeric := 0; v_post_discount numeric := 0;
  v_tax_refund numeric := 0; v_shipping_refund numeric := 0; v_returned_merch numeric := 0; v_allocated_discount numeric := 0; v_taxable_returned numeric := 0;
